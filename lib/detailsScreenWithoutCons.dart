...
class DetailsScreenWithoutCons extends StatelessWidget {
  // final Map<dynamic, dynamic> place;
  const DetailsScreenWithoutCons({super.key});

  @override
  Widget build(BuildContext context) {
    final List<Map<String, dynamic>> places =
        campusData[0]['places'] as List<Map<String, dynamic>>;
    final Map<String, dynamic> place = places[0];
